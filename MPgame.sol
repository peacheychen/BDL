...
contract MatchPennies {
    ...
    modifier isJoinable() {   //compare to list of 1-5
        ...
        require(msg.value == (1 ether) ,
                "Your choice of stake  is not valid, it should be one of .");
        _;
    }
    ...
    modifier isValidChoice(uint _playerChoice) {
        require(
                _playerChoice == 1 ||
                _playerChoice == 2 , 
                "Your choice is not valid, it should be 1 or 2.");
        _;
    }
        ...
        isJoinable() // To join the game, there must be a free space
    {
        if (player1 == address(0)){
            ...
            stakeOfPlayer1 = msg.value; 

    } else {
            player2 = payable(msg.sender);
            stakeOfPlayer2 = msg.value; 
            }
    }
        ...
        
    {
        ...
        discloseRun = true;
        if (choiceOfPlayer2 == choiceOfPlayer1 ) {
            winner = player1; 

        } else if (choiceOfPlayer2 !=  choiceOfPlayer1 ) {
            winner = player2;
